...
const CATEGORIES = {
  ...
  summary: {
    label: 'Summary',
    description: 'KeepPreAsap, SummaryBinaryOp, MembershipFilter, ValueOperation, SummaryAgg, SummaryJoin, SummarySubtract, SummaryDelete, SummaryEstimate, SummaryMerge — post-ASAP materialized structures',
