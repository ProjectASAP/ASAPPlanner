...
//! object store. This module defines their kinds and
...
mod tests {
    ...
    /// Boundary JSON keeps separate counters and only the evidence used for each kind.
    #[test]
    fn boundary_json_round_trip() {
        ...
        let kind = BoundaryKind::Materialization;
