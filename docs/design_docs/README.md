...
Design documentation explains the planner’s concepts, architecture, accepted
decisions, and evolving proposals.

- [Concepts](concepts/README.md) introduces the planner pipeline, vocabulary,
